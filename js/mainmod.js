...
$.ajaxSetup({ cache: false });
 ...
 //var = "http://192.168.3.55/servicios/room.php"
...
$.ajaxSetup({ cache: false });
        ...
        var url = "http://192.168.3.55/servicios/room.php?room="+room;
...
$.ajaxSetup({ cache: false });
        $.getJSON("http://192.168.3.55/backend/categorias_read.php", function(data){ 
...
function productos(id){
        ...
        $.getJSON("http://192.168.3.55/backend/productos_read.php?id_categoria="+id, function(data){ 
...
function cuenta(){
    ...
    //
    /*var url = "http://192.168.3.55/servicios/cuenta.php?reserva="+res+"&room="+roo;
...
function sendPedido(pago){
    ...
    var url = "http://192.168.3.55/controller/crear_orden.php";
     console.log("URL CUENTA "+url);
